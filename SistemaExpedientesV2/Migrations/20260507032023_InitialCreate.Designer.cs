...
namespace SistemaExpedientesV2.Migrations
{
    ...
    [Migration("20260507032023_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SistemaExpedientesV2.Models.Alumno", b =>
                {
            ...
            modelBuilder.Entity("SistemaExpedientesV2.Models.Expediente", b =>
                {
            ...
            modelBuilder.Entity("SistemaExpedientesV2.Models.Materia", b =>
                {
                    b.Property<int>("MateriaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SistemaExpedientesV2.Models.Expediente", b =>
                {
                    b.HasOne("SistemaExpedientesV2.Models.Alumno", "Alumno")
                        .WithMany("Expedientes")
                        .HasForeignKey("AlumnoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SistemaExpedientesV2.Models.Materia", "Materia")
                        .WithMany("Expedientes")
